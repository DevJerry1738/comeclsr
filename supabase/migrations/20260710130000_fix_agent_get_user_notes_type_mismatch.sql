-- Fix: "Returned type integer does not match expected type bigint in column 1"
-- agent_user_notes.id is SERIAL (integer), but the function declared note_id BIGINT.
-- Change return type to INTEGER to match the actual column type.
