-- Fix conversation RPCs to return the agent's full_name from user_profiles instead of agents.display_name
-- Because admin updates are applied to user_profiles
