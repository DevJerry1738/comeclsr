-- 20260610_fix_agent_assigned_users_timestamp.sql
-- Fix timestamp type mismatch in agent_get_assigned_users RPC
...
BEGIN
  ...
  WITH all_users AS (
    ...
    SELECT 
      ...
      us.expires_at::TIMESTAMP AS u_sub_expires,  -- cast to timestamp without tz
