-- 20260624160000_add_agent_details_to_my_conversations.sql
-- Update conversation_my_conversations to return agent profile details:
-- bio, location, age, and interests.
