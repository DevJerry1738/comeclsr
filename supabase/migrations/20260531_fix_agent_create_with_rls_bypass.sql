-- 20260531_fix_agent_create_with_rls_bypass.sql
-- Fix agent creation by ensuring RLS doesn't block the RPC function

-- Step 1: Drop the existing function
DROP FUNCTION IF EXISTS public.agent_create_account(TEXT, TEXT);

-- Step 2: Create a new function with explicit RLS disabling
